...
<meta name="keywords" content="" />
  ...
  <link href="resources/dccfavicon.png" rel="shortcut icon" type="image/x-icon" />
  <link href="resources/dccfavicon.png" rel="icon" type="image/x-icon" />
...
@media only screen and (max-width : 736px) {
    ...
    .mob_menu {
        ...
        z-index: 1;
        background: #ffffff;;
        background: rgba(1,185,249,1.00);;
        ;
    }
...
a:visited, .sys_txt a:visited, .sys_layout a:visited {color: #8ddae6;}
      ...
      <a href="contact.php" title="Contact">Contact</a>
                                            ...
                                            <h1>
                                                <a id="sys_heading" class="yola_show_logo" href="./">
                                                    <img class="yola_site_logo" src="resources/Logos/new-logo.png" alt="Dublin City Comics" >
                                                    <span>Dublin City Comics</span>
                                                </a>
                                            </h1>
                                        </div>
                    ...
                    <div class="yola_footer_wrap">
                        <div class="yola_footer_column">
                            <footer id="yola_style_footer">
                                <p style="float:right; margin:0;">103-104 Capel Street, Dublin, Dublin Dublin 1, Ireland | 353857717633</p><div style="clear:both; height:0;"></div>
                            </footer>
                        </div>
                    </div>
                    
                    
<script type="text/javascript" id="site_analytics_tracking" data-id="6d67bb7569f74b24afd86223cc217c1e" data-user="39262758b9fe449ca41de1e1bf8eb038" data-partner="WL_HOSTINGIRELAND" data-url="//analytics.yolacdn.net/tracking.js">
  var _yts = _yts || [];
